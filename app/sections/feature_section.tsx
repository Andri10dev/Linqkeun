    ...
    return (
        <div id="featureSection" className="h-screen w-full bg-custom-blue pt-16 relative">
            ...
            <div className="flex items-center justify-center absolute bottom-0 w-full h-[85%] md:h-[80%] text-white text-xs md:text-base">
                <button className="h-32 aspect-square rounded-full bg-red-500 absolute top-0 md:top-16 lg:top-0 text-center hover:scale-105 transition-all duration-300">
                    Sales & Marketing
                </button>
                <button className="h-32 aspect-square rounded-full bg-red-500 absolute top-[20%] right-2 md:top-[15%] md:right-[15%] lg:right-[25%] text-center">
                    Inventory management
                </button>
                <button className="h-32 aspect-square rounded-full bg-red-500 absolute p-3 bottom-[35%] right-8 md:bottom-[45%] lg:bottom-[25%] md:right-[20%] text-center">
                ...
                <Image src={Feature} alt="Linqkeun Feature" className="absolute bottom-10 md:bottom-24 lg:bottom-0 w-4/5 md:w-[80%] lg:w-1/3 aspect-video object-contain"></Image>
            </div>
        </div>
    )
}
