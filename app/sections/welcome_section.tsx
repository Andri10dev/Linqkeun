        ...
        <div id='welcomeSection' className="w-full h-fit md:h-screen relative">
            ...
            <div className='w-full px-5 md:px-10 flex flex-col md:flex-row'>
                ...
                <div className='md:w-1/2 flex flex-col justify-end items-center md:items-end pb-[100px] md:pb-0'>
                    <Image src={DocLinqkeun} alt='linqkeun - merchandise' className='h-[250px] aspect-video object-contain md:-mt-5 md:-mr-32'></Image>
                    <Image src={Kaos} alt='linqkeun - merchandise' className='w-[200px] aspect-square object-contain self-center md:mr-5 md:-mt-16'></Image>
                </div>
            </div>
        </div>
    )
